        ...
        <div class="container mt-5 pt-5">
            <div class="row">
                <div class="col-md-6 mb-5">
                    ...
                    <p class="m-0">Accusam nonumy clita sed rebum kasd eirmod elitr. Ipsum ea lorem at et diam est,
                        tempor rebum ipsum sit ea tempor stet et consetetur dolores. Justo stet diam ipsum lorem vero clita
                        diam</p>
                </div>
                <div class="col-md-6 mb-5">
            ...
            <div class="row">
                <div class="col-md-4 mb-5">
                    ...
                    <p><i class="fa fa-map-marker-alt mr-2"></i>Paota C Road , Jodhpur</p>
                    <p><i class="fa fa-phone-alt mr-2"></i>+9198285228140</p>
                    <p><i class="fa fa-envelope mr-2"></i>inaniyakapil2000@gmail.com</p>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-6 text-center text-md-right">
                    <p class="m-0">Designed by <a class="text-white" href="">kapil</a>
                    </p>
                </div>
            </div>
        </div>
