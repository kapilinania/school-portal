                    ...
                    <div class="card comman-shadow">
                        <div class="card-body">
                            <form action="{{ route('teacher.exams.store') }}" method="POST">
                                ...
                                <div class="row">
                                    <div class="col-12">
                                        <h5 class="form-title student-info">Exam Information <span><a href="javascript:;"><i
                                            ...
                                            <select name="subject_id" id="subject" class="form-control" required>
                                                @foreach ($subjects as $subject)
                                                    <option value="{{ $subject->id }}"
                                                        data-section="{{ $subject->section }}">{{ $subject->name }}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-12 col-sm-4">
                                        <div class="form-group local-forms">
                                            ...
                                            <input type="text" name="duration" class="form-control" id="duration"
                                                placeholder="00:30" value="{{ old('duration') }}" required>
                                            <small class="form-text text-muted">Please enter time in HH:MM format. Example:
                                                00:30 for 30 minutes.</small>
                                        </div>
                                    </div>
                                    <div class="col-12">
