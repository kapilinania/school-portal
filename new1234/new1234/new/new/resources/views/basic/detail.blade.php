...
@section('content')
    <!-- Paste the content of about.html here -->
    <!-- Header Start -->
        ...
        <div class="row">
            <div class="col-lg-8">
                <div class="mb-5">
                    ...
                    <img class="img-fluid rounded w-100 mb-4" src="{{ asset('assets/indeximg/header.jpg') }}" alt="Image">
                ...
                <div class="owl-carousel related-carousel position-relative" style="padding: 0 30px;">
                    @foreach(range(1, 3) as $index)
                        <a class="courses-list-item position-relative d-block overflow-hidden mb-2" href="{{ route('course.detail', ['id' => $index]) }}">
                            <img class="img-fluid" src="{{ asset('assets/indeximg/courses-' . $index . '.jpg') }}" alt="Related Course Image {{ $index }}">
            ...
            <div class="col-lg-4 mt-5 mt-lg-0">
                <div class="bg-primary mb-5 py-3">
                    ...
                    <div class="py-3 px-4">
                        <a class="btn btn-block btn-secondary py-3 px-5" href="{{ route('enroll') }}">Enroll Now</a>
                    </div>
                </div>
                ...
                <div class="mb-5">
                    ...
                    @foreach(range(1, 4) as $index)
                        <a class="d-flex align-items-center text-decoration-none mb-4" href="{{ route('course.detail', ['id' => $index]) }}">
                            <img class="img-fluid rounded" src="{{ asset('assets/indeximg/courses-80x80.jpg') }}" alt="Recent Course Image {{ $index }}">
                            <div class="pl-3">
