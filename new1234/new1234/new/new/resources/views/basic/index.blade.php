@extends('layouts.basic') <!-- Assuming you have a common layout file -->
            ...
            <div class="row">
                <div class="col-lg-5 mb-5 mb-lg-0" style="min-height: 500px;">
                    <div class="position-relative h-100">
                        <img class="position-absolute w-100 h-100" src="{{asset('assets/indeximg/about.jpg') }}" style="object-fit: cover;">
                    </div>
                </div>
                <div class="col-lg-7">
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-5" style="min-height: 500px;">
                    <div class="position-relative h-100">
                        <img class="position-absolute w-100 h-100" src="{{asset('assets/indeximg/feature.jpg') }}" style="object-fit: cover;">
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="container-fluid px-0 py-5">
        ...
        <div class="owl-carousel courses-carousel">
            <div class="courses-item position-relative">
                <img class="img-fluid" src="{{asset('assets/indeximg/courses-1.jpg') }}" alt="">
            ...
            <div class="courses-item position-relative">
                <img class="img-fluid" src="{{asset('assets/indeximg/courses-2.jpg') }}" alt="">
                <div class="courses-text">
                    <h4 class="text-center text-white px-3">Web design & development courses for beginners</h4>
                    <div class="border-top w-100 mt-3">
                        <div class="d-flex justify-content-between p-4">
            ...
            <div class="courses-item position-relative">
                <img class="img-fluid" src="{{asset('assets/indeximg/courses-3.jpg') }}" alt="">
                <div class="courses-text">
                    <h4 class="text-center text-white px-3">Web design & development courses for beginners</h4>
                    <div class="border-top w-100 mt-3">
                        <div class="d-flex justify-content-between p-4">
            ...
            <div class="courses-item position-relative">
                <img class="img-fluid" src="{{asset('assets/indeximg/courses-4.jpg') }}" alt="">
                <div class="courses-text">
                    <h4 class="text-center text-white px-3">Web design & development courses for beginners</h4>
                    <div class="border-top w-100 mt-3">
                        <div class="d-flex justify-content-between p-4">
            ...
            <div class="courses-item position-relative">
                <img class="img-fluid" src="{{asset('assets/indeximg/courses-5.jpg') }}" alt="">
                <div class="courses-text">
                    <h4 class="text-center text-white px-3">Web design & development courses for beginners</h4>
                    <div class="border-top w-100 mt-3">
                        <div class="d-flex justify-content-between p-4">
            ...
            <div class="courses-item position-relative">
                <img class="img-fluid" src="{{asset('assets/indeximg/courses-6.jpg') }}" alt="">
                <div class="courses-text">
                    <h4 class="text-center text-white px-3">Web design & development courses for beginners</h4>
                    <div class="border-top w-100 mt-3">
                        <div class="d-flex justify-content-between p-4">
    ...
    <div class="container-fluid py-5">
        <div class="container py-5">
            ...
            <div class="owl-carousel team-carousel position-relative" style="padding: 0 30px;">
                <div class="team-item">
                    <img class="img-fluid w-100" src="{{asset('assets/indeximg/team-1.jpg') }}" alt="">
                ...
                <div class="team-item">
                    <img class="img-fluid w-100" src="{{asset('assets/indeximg/team-2.jpg') }}" alt="">
                    <div class="bg-light text-center p-4">
                        <h5 class="mb-3">Instructor Name</h5>
                        <p class="mb-2">Web Design & Development</p>
                        <div class="d-flex justify-content-center">
                ...
                <div class="team-item">
                    <img class="img-fluid w-100" src="{{asset('assets/indeximg/team-3.jpg') }}" alt="">
                    <div class="bg-light text-center p-4">
                        <h5 class="mb-3">Instructor Name</h5>
                        <p class="mb-2">Web Design & Development</p>
                        <div class="d-flex justify-content-center">
                ...
                <div class="team-item">
                    <img class="img-fluid w-100" src="{{asset('assets/indeximg/team-4.jpg') }}" alt="">
                    <div class="bg-light text-center p-4">
                        <h5 class="mb-3">Instructor Name</h5>
                        <p class="mb-2">Web Design & Development</p>
                        <div class="d-flex justify-content-center">
                    ...
                    <div class="owl-carousel testimonial-carousel">
                        <div class="bg-white p-5">
                            ...
                            <div class="d-flex flex-shrink-0 align-items-center mt-4">
                                <img class="img-fluid mr-4" src="{{asset('assets/indeximg/testimonial-2.jpg') }}" alt="">
                                <div>
                                    <h5>Student Name</h5>
                        ...
                        <div class="bg-white p-5">
                            ...
                            <p>Sed et elitr ipsum labore dolor diam, ipsum duo vero sed sit est est ipsum eos clita est
                                ...
                                stet amet elitr duo lorem</p>
                            <div class="d-flex flex-shrink-0 align-items-center mt-4">
                                <img class="img-fluid mr-4" src="{{asset('assets/indeximg/testimonial-1.jpg') }}" alt="">
                                <div>
                                    <h5>Student Name</h5>
                                    <span>Web Design</span>
                                </div>
                ...
                <div class="col-lg-5 mb-5 mb-lg-0">
                    <div class="bg-light d-flex flex-column justify-content-center px-5" style="height: 450px;">
                        <div class="d-flex align-items-center mb-5">
                            ...
                            <div class="mt-n1">
                                <h4>Our Location</h4>
                                <p class="m-0">Paota C Road , Jodhpur</p>
                            </div>
                        </div>
                        <div class="d-flex align-items-center mb-5">
                            <div class="btn-icon bg-secondary mr-4">
                        ...
                        <div class="d-flex align-items-center">
                            ...
                            <div class="mt-n1">
                                <h4>Email Us</h4>
                                <p class="m-0">inaniyakapil2000@gmail.com</p>
                            </div>
                        </div>
                    </div>
                </div>
