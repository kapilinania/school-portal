            ...
            <div class="row">
                <div class="col-lg-5 mb-5 mb-lg-0" style="min-height: 500px;">
                    <div class="position-relative h-100">
                        <img class="position-absolute w-100 h-100" src="{{ asset('assets/indeximg/about.jpg') }} "
        ...
        <div class="container py-5">
            <div class="row">
                ...
                <div class="col-lg-5" style="min-height: 500px;">
                    <div class="position-relative h-100">
                        <img class="position-absolute w-100 h-100" src="{{ asset('assets/indeximg/feature.jpg') }}"
                            style="object-fit: cover;">
                    </div>
                </div>
            </div>
